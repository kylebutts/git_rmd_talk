...
- Cloning repository downloads all the files into a folder onto your computer and sets up everything to connect to Github.
- This allows you to make changes locally and publish them to Github, i.e. collaborate with coauthors.


**Forking**:

- This copies the contents of a repository into your own repository (including full history). Any future commits do not go to the original owner's repository.
- This should not be used if you are collaborating with people. 
